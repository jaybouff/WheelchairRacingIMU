...
for i=x:n
    ...
    baseline2(:,i)=mean(ENCO.baseline2(1:1000,temp(end-49:end),i),2); %baseline is the last 50 valid strides with tride duration higher than mean - std of this subject during baseline 
    velocitybaseline2(:,i)=mean(Velocity.baseline2(1:1000,temp(end-49:end),i),2);
    clear temp
