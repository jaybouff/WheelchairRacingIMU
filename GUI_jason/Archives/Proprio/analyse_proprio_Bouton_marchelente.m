...
for i=1:length(STIM)
    ...
    if Cycle_Table(STIM(i),3)==1
        ...
        [onsetCF(i), y]=find(abs(a)>=0.7,1,'first');%ATTENTION: plus le max, mais le seuil de debut du CF
       ...
       %plot(tempSTIM,'r')
        ...
        deltaCOUPLE(1:length(deltaF),i)=deltaF;
...
variable.deltaCOUPLE=deltaCOUPLE;
