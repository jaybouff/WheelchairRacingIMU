...
for isegment = 1: length(Segments)
    for itrial = 1:size(Goodtrials,2)
        ...
        Table.(Segments{isegment}).AccelX.rawdata(:,itrial) = data.(Segments{isegment}).data(trials(Goodtrials(itrial),1):trials(Goodtrials(itrial),2),Accelchannel(1));
        Table.(Segments{isegment}).AccelY.rawdata(:,itrial) = data.(Segments{isegment}).data(trials(Goodtrials(itrial),1):trials(Goodtrials(itrial),2),Accelchannel(2));
        Table.(Segments{isegment}).AccelZ.rawdata(:,itrial) = data.(Segments{isegment}).data(trials(Goodtrials(itrial),1):trials(Goodtrials(itrial),2),Accelchannel(3));
        Table.(Segments{isegment}).GyroX.rawdata(:,itrial) = data.(Segments{isegment}).data(trials(Goodtrials(itrial),1):trials(Goodtrials(itrial),2),Gyrochannel(1));
        Table.(Segments{isegment}).GyroY.rawdata(:,itrial) = data.(Segments{isegment}).data(trials(Goodtrials(itrial),1):trials(Goodtrials(itrial),2),Gyrochannel(2));
        Table.(Segments{isegment}).GyroZ.rawdata(:,itrial) = data.(Segments{isegment}).data(trials(Goodtrials(itrial),1):trials(Goodtrials(itrial),2),Gyrochannel(3));
        Table.(Segments{isegment}).Quat1.rawdata(:,itrial) = data.(Segments{isegment}).data(trials(Goodtrials(itrial),1):trials(Goodtrials(itrial),2),Quatchannel(1));
        Table.(Segments{isegment}).Quat2.rawdata(:,itrial) = data.(Segments{isegment}).data(trials(Goodtrials(itrial),1):trials(Goodtrials(itrial),2),Quatchannel(2));
        Table.(Segments{isegment}).Quat3.rawdata(:,itrial) = data.(Segments{isegment}).data(trials(Goodtrials(itrial),1):trials(Goodtrials(itrial),2),Quatchannel(3));
        Table.(Segments{isegment}).Quat4.rawdata(:,itrial) = data.(Segments{isegment}).data(trials(Goodtrials(itrial),1):trials(Goodtrials(itrial),2),Quatchannel(4));
