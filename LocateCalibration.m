...
for isegment = 1:length(Segments)
    ...
    Calib.Participant.Statique.(Segments{isegment}).Gyro =data.(Segments{isegment}).data(ParticipantStat(1):ParticipantStat(2),Gyrochannel);
    Calib.Participant.Statique.(Segments{isegment}).Accel =data.(Segments{isegment}).data(ParticipantStat(1):ParticipantStat(2),Accelchannel);
    Calib.Participant.Statique.(Segments{isegment}).Quat =data.(Segments{isegment}).data(ParticipantStat(1):ParticipantStat(2),Quatchannel);
